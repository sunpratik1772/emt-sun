-- dbSherpa Studio — SQLite schema reference (v5)
-- Canonical copies:
--   MySQL / Cloud SQL → backend/sql/001_schema_mysql.sql
--   SQLite            → backend/sql/002_schema_sqlite.sql
-- Apply: python3 backend/scripts/apply_sqlite_schema.py
-- Docs:  docs/db/README.md
