    ...
    return (
      <div className="p-3 border-t shrink-0" style={{ borderColor: 'var(--border)' }}>
        ...
        {currentWorkflow && (() => {
          ...
          const chipBg = 'color-mix(in srgb, var(--bg-3) 70%, transparent)'
          const chipBorder = 'var(--border-soft)'
          const chipColor = hints.length ? 'var(--text-2)' : 'var(--accent)'
          const parts: string[] = [
            mode === 'run'
        ...
        <div className="relative flex gap-2">
          ...
          <Button
            ...
            variant={isLoading ? 'stop' : input.trim() ? 'primary' : 'ghost'}
            className="self-end"
            style={{ minWidth: 40, minHeight: 36, borderRadius: 8, padding: '8px 12px' }}
